...
##########################################################################################
Write-Output "*****************************************************************************************"
Write-Output "Welcome to Performance Starter Kit 'A one stop solution' loaded with the following features:`n1. Converting Legacy JMeter Test Scripts: The kit converts legacy JMeter test scripts to the Azure Load Testing (ALT) compatible format `n2. Azure Load Test Setup and Execution: It creates the Azure Load Test setup and executes JMeter test scripts within Azure Load Testing.  `n3. JAVA Download and installation as JMeter prerequisite `n4. JMeter Download and SetupEnvironment Variable setup for Java and JMeter `n5. Create JMeter script Master Template (For majority of script reference)`n6. JMeter suite creation as per Swagger or APIM `n7. JMeter HTML Reporting Creation from .jtl"
Write-Output "*****************************************************************************************"
